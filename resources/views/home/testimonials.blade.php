        ...
        <div class="container">
            ...
            <div class="mt-5 row">
                <div class="mt-3 col-md-6" data-aos="fade-right">
                    <div class="border-0 shadow-sm shadow card">
                        <div class="p-5 card-body testimonial-item">
                            ...
                            <strong class="d-block">Yuda Ristian</strong>
                            <small class="text-muted">CEO & Founder</small>
                            <p class="mt-3 fst-italic fs-5">
                                <i class="fa fa-quote-left"></i>
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                                Voluptates aut sit, cupiditate culpa, dolorum harum porro esse
                                facilis distinctio enim similique id totam quas nihil sint,
                                doloremque fugit odit repellat?
                ...
                <div class="mt-3 col-md-6">
                    <div class="border-0 shadow-sm shadow card" data-aos="fade-left">
                        <div class="p-5 card-body testimonial-item">
                            <img src="/assets/img/t1.jpg" alt=""
                                class="img-testimonial float-start rounded-circle me-3" />
                            <strong class="d-block">Yuda Ristian</strong>
                ...
                <div class="mt-3 col-md-6">
                    <div class="border-0 shadow-sm shadow card" data-aos="fade-right">
                        <div class="p-5 card-body testimonial-item">
                            <img src="/assets/img/t1.jpg" alt=""
                                class="img-testimonial float-start rounded-circle me-3" />
                            <strong class="d-block">Yuda Ristian</strong>
                ...
                <div class="mt-3 col-md-6" data-aos="fade-left">
                    <div class="border-0 shadow-sm shadow card">
                        <div class="p-5 card-body testimonial-item">
                            <img src="/assets/img/t1.jpg" alt=""
                                class="img-testimonial float-start rounded-circle me-3" />
